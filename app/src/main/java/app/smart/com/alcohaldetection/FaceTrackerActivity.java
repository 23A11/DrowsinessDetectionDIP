...
import app.smart.com.alcohaldetection.ui.camera.CameraSourcePreview;
import app.smart.com.alcohaldetection.ui.camera.GraphicOverlay;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private Button end_button,logout;
    ...
    public int flag = 0;
    GPSTracker gps;
    Double latitude,longitude,speed1;
    @Override
    public void onCreate(Bundle icicle) {
        ...
        Timer obj=new Timer();
        tt obj1=new tt();
        obj.schedule(obj1,2000,2010);


        n_mode=(ToggleButton)findViewById(R.id.toggleButton);
        n_mode.setTextOn("HI-Mode ON");
        n_mode.setText("HI-Mode");
        n_mode.setTextOff("HI-Mode OFF");
...
//                FaceTrackerActivity.this.finish();
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void sendsms()
        {
            String geo=lati+","+longi;
            String url="http://maps.google.com/maps?q="+geo+"&"+geo+"&z=17";
            String msg=url+"\n"+"This is an emergency situation.";
            // Get the default instance of the SmsManager
            SmsManager smsManager = SmsManager.getDefault();
            HashMap<String,String> h=userSessionManager.getUserDetails();

            smsManager.sendTextMessage( "7982975866",
                    null,
                    msg,
                    null,
                    null);
